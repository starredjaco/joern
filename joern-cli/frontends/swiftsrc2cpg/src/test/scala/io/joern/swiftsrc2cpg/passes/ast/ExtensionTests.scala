  ...
  "ExtensionTests" should {
    ...
    "do not create illegal ref edges for subscript functions" in {
      ...
      inside(cpg.call.nameExact("reduce").receiver.l) { case List(id: Identifier) =>
        ...
        local.closureBindingId.loneElement shouldBe "Ext1.swift:<global>.Foo.<subscript>0.get:ANY:path"
      }
      val List(subscriptMethod1)         = cpg.method.nameExact("<subscript>0").l
      ...
      closureBindingPath1.closureBindingId shouldBe Option("Ext1.swift:<global>.Foo.<subscript>0.get:ANY:path")
      ...
      inside(cpg.call.codeExact("self[path]").argument(2).l) { case List(id: Identifier) =>
        ...
        local.closureBindingId.loneElement shouldBe "Ext1.swift:<global>.Foo.<subscript>1.get:ANY:path"
      }
      val List(subscriptMethod2)         = cpg.method.nameExact("<subscript>1").l
      ...
      closureBindingPath2.closureBindingId shouldBe Option("Ext1.swift:<global>.Foo.<subscript>1.get:ANY:path")
